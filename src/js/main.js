...
let modalWindow = document.querySelector('.modal-map-wrap');
let positionMap = document.getElementById('map');
let closeMap = document.querySelector('.close');
